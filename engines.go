...
func TranslateAll(to string, from string, query string) []LangOut {
	engines := []string{"google", "mymemory", "yandex", "deepl", "duckduckgo", "gemini", "textra", "groq", "gptoss", "gemma", "nemotron", "mistral"}
	langout := []LangOut{}
...
func TranslateSome(engines []string, to string, from string, query string) ([]LangOut, error) {
	enginesFull := []string{"google", "mymemory", "yandex", "deepl", "duckduckgo", "gemini", "textra", "groq", "gptoss", "gemma", "nemotron", "mistral"}
	for i := range engines {
		valid := false
